...
def model(X, Y, model_name="_without_regularization",
          learning_rate=0.3, num_iterations=30000, print_cost=True,
          lambd=0, keep_prob=1):
    """
    ...
    for i in range(0, num_iterations):
        ...
        # 使用dropout
            ...
            a3, cache = reg_utils.forward_propagation_with_dropout(
        ...
        # 使用L2正则化
            ...
            cost = reg_utils.compute_cost_with_regularization(
        ...
        # 使用L2正则化
            ...
            grads = reg_utils.backward_propagation_with_regularization(
                X, Y, cache, lambd)
        # 使用dropout
        elif keep_prob < 1:
            grads = reg_utils.backward_propagation_with_dropout(
                X, Y, cache, keep_prob)
...
def main():
    ...
    # 读入数据集
    train_X, train_Y, test_X, test_Y = reg_utils.load_2D_dataset("data")
